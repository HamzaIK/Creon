...
const Pass = () => {
    return (
        ...
        <div className="xl:grid px-[12.5vw] xl:grid-cols-2 xl:py-[8.219vw] xl:grid-rows-1 xl:gap-4">
            ...
            <video src={"https://res.cloudinary.com/dsztrskv1/video/upload/v1714951579/nft-video_kfdqvk.mp4"} loop muted autoPlay preload="metadata" className='xl:h-full h-[110vw]  object-cover w-full  ' />
