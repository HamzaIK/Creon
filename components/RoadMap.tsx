...
const RoadMap = () => {
  return (
    <div className='mt-24 relative  '>
        ...
        <video className='absolute -z-20 opacity-30 object-cover left-0 bottom-0 w-full  xl:top-0' src={"https://res.cloudinary.com/dsztrskv1/video/upload/v1714952010/roadmap-video_pz0t1t.mp4"} loop muted autoPlay preload="metadata" ></video>
