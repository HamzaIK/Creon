...
const Profiting = () => {
  ...
  <div className='xl:flex items-center '>
    ...
    <video src={video2} height={200} loop muted autoPlay preload="metadata" className=' -z-40 top-0 my-5 xl:my-0 rounded-lg object-cover xl:w-[49.323vw] w-full xl:h-[25.26vw] mr-8   ' />
